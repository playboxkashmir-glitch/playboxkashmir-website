...
// Combines list/create and single-facility update into one dynamic catch-all
// route file to stay within the Vercel Hobby plan's 12-function limit.
// Public paths are unchanged: /api/facilities, /api/facilities/:id.
