...
// /api/bookings?id=123                        (GET/PATCH/DELETE single)
// /api/bookings?resource=availability&date=..  (GET availability)
// /api/bookings?resource=send-confirmation     (POST send confirmation email)
...
if (resource === 'availability') return handleAvailability(req, res);
if (resource === 'send-confirmation') return handleSendConfirmation(req, res);
